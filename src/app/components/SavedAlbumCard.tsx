...
export default function SavedAlbumCard({id, index, title, artists, cover, releaseDate, dateAdded, removeSavedAlbum} : SavedAlbumProps) {
    ...
    return (
        ...
        >
            {(provided) => (
                ...
                >
                    <div
                        className="w-1/7 h-full flex justify-center items-center transition-all hover:border-2 hover:bg-[#454545] active:transition-none active:border-3 active:border-mq-lightblue cursor-grab rounded-l-3xl saved_albums_hamburger_icon"
